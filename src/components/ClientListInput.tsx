      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div className="flex flex-col">
          <label className="text-slate-300 font-bold text-[10px] uppercase tracking-wider mb-1 flex justify-between">
            ...
            <span className="font-mono text-slate-400">Total: <strong className="text-orange-500">{clientList.length}</strong></span>
          </label>
        ...
        <div className="flex flex-col bg-[#050505]/40 border border-white/10 rounded p-2.5">
          <span className="text-[10px] uppercase tracking-wider font-bold text-slate-400 mb-1.5 flex items-center gap-1">
            ...
            Empresas Identificadas ({clientList.length})
          </span>
          ...
          {clientList.length === 0 ? (
            ...
            <div className="flex-1 overflow-y-auto max-h-[120px] pr-1 space-y-1">
              {clientList.map((client, index) => {
                const isUrl = client.startsWith("http://") || client.startsWith("https://");
                return (
                  <div
                    key={index}
                  ...
                  >
                    ...
                    <button
                      ...
                      className="text-slate-500 hover:text-red-400 p-0.5 rounded transition-all ml-1.5"
                      title="Excluir"
                    >
